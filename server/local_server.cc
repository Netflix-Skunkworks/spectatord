...
LocalServer::LocalServer(asio::io_context& io_context, std::string_view path, handler_t handler)
    : handler_{std::move(handler)}, socket_{io_context, asio::local::datagram_protocol::endpoint{path}}
{
}
