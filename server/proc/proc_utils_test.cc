...
TEST(ProcUtils, max_buffer)
{
	...
	EXPECT_EQ(max_buffer_size("test-resources/rmem_max"), 65536);
	EXPECT_EQ(max_buffer_size("test-resources/rmem_max"), 65536);
	EXPECT_EQ(max_buffer_size("test-resources/rmem_max"), 65536);
