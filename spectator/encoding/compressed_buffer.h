...
class CompressedBuffer
{
   public:
	...
	explicit CompressedBuffer(size_t chunk_size_input = kDefaultChunkSizeInput, size_t out_size = kDefaultOutSize,
	...
	{
		static_assert(((std::is_convertible_v<std::decay_t<Args>, std::string_view> ||
